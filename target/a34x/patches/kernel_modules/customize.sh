[ ! -f "$WORK_DIR/kernel/vendor_boot.img" ] && ABORT "File not found: ${WORK_DIR//$SRC_DIR\//}/kernel/vendor_boot.img"
...
[ ! -f "$TMP_DIR/out/vendor_ramdisk00" ] && ABORT "Failed to extract vendor_boot.img\n\n$MKBOOTIMG_ARGS"
