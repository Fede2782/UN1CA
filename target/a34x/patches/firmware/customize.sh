...
for f in A346B A346E A346M A346N A3460; do
    ...
    for i in $PARTITIONS; do
        ...
        [[ "$i" == "dtbo.img" ]] && EVAL "unlz4 -f \"$TMP_DIR/$i.lz4\" \"$WORK_DIR/kernel/${i/\.img/-$f-verified\.img}\"" \
           || EVAL "unlz4 -f \"$TMP_DIR/$i.lz4\" \"$WORK_DIR/kernel/${i/-verified.img/-$f-verified.img}\""
    done
